...
qemu-system-x86_64 --enable-kvm \
        -cpu IvyBridge -machine type=pc,accel=kvm -smp 4 \
        -kernel $HOME/qemux86-64/bzImage-qemux86-64.bin \
        ...
        -device AC97 -m 8G -vga virtio -usb -device usb-tablet -display sdl,gl=on
